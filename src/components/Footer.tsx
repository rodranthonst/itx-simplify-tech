    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">ITX</h3>
            <p className="text-gray-400 mb-4">
              Soluciones tecnológicas simples, efectivas y adaptadas para tu negocio.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Portal de clientes</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center text-sm text-gray-500">
          <p>&copy; {currentYear} ITX Uruguay. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
